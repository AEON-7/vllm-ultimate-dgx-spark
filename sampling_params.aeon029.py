...
def validate_reasoning_eos_policy(value: str | None) -> str:
    ...
    if value is None:
        return "force_end"
    if not isinstance(value, str) or value not in ("stop", "force_end"):
        raise VLLMValidationError(
...
class SamplingParams(
    ...
    reasoning_eos_policy: ReasoningEosPolicy = "force_end"
    ...
    def __post_init__(self) -> None:
        ...
        self.reasoning_eos_policy = validate_reasoning_eos_policy(
            getattr(self, "reasoning_eos_policy", None)
        )
