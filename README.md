...
[![vLLM](https://img.shields.io/badge/vLLM-0.27.1%2Baeon.sm__121a.dspark-orange)](https://github.com/vllm-project/vllm)
...
Built on **vLLM v0.27.1 compiled from source for sm_121a**, merged with the AEON speculative-decoding stack: **DSpark Markov-head speculation (quantized heads)** + Triton software **NVFP4 KV cache** (PR #44389, NHD-safe rewrite) + **DFlash** (SWA drafters native on Model-Runner-V2) + the **AEON DGX Spark runtime patches** + **TurboQuant**.
